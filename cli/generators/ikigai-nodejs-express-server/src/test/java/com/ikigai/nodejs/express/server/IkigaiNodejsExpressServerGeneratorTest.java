 ...
 * 1) Set a break point in IkigaiNodejsExpressServerGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class IkigaiNodejsExpressServerGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("ikigai-nodejs-express-server") // use this codegen library
              ...
              .setOutputDir("out/ikigai-nodejs-express-server"); // output directory
