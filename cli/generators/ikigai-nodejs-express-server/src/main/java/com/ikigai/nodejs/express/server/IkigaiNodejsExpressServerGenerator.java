package com.ikigai.nodejs.express.server;
...
public class IkigaiNodejsExpressServerGenerator extends DefaultCodegen implements CodegenConfig {

  private final Logger LOGGER = LoggerFactory.getLogger(IkigaiNodejsExpressServerGenerator.class);
  ...
  public IkigaiNodejsExpressServerGenerator() {
      super();
      ...
      outputFolder = "generated-code/ikigai-nodejs-express-server";
      embeddedTemplateDir = templateDir = "ikigai-nodejs-express-server";
      ...
      supportingFiles.add(new SupportingFile("controllers" + File.separator + "BaseController.mustache", "controllers", "BaseController.js"));
      // service folder
      supportingFiles.add(new SupportingFile("services" + File.separator + "index.mustache", "services", "index.js"));
      supportingFiles.add(new SupportingFile("services" + File.separator + "BaseService.mustache", "services", "BaseService.js"));
  ...
  public String getName() {
      return "ikigai-nodejs-express-server";
  }
  ...
  public String getHelp() {
      return "Generates a NodeJS Express server. IMPORTANT: this generator may subject to breaking changes without further notice.";
  }
